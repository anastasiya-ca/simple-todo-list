...
public class TodoItemTable {
	...
	public static String getCreateSQL() {
		return "CREATE TABLE " + TABLE_NAME + " ("
				+ "_id INTEGER PRIMARY KEY AUTOINCREMENT, " + NAME_COL_NAME + " TEXT, "
				+ PRIORITY_COL_NAME + " INTEGER, "
				+ STATUS_COL_NAME + " TEXT);";
	}

	public static String getInsertNewTodoSQL(String name, int priority, String status) {
		return "INSERT INTO " + TABLE_NAME + " ("
				+ NAME_COL_NAME + ", " + PRIORITY_COL_NAME + ", " + STATUS_COL_NAME + ") "
				+ " SELECT '" +  name + "' as " + NAME_COL_NAME + ", "
				+  priority + " as " + PRIORITY_COL_NAME + ", '"
				+ status + "' as " + STATUS_COL_NAME + ";";
	}
